...
export default function PlanejamentoPage() {
  const metricas = [
    { label: 'Taxa de Estimativa Correta',  icon: '🎯', meta: '≥ 80%',  desc: 'SPs entregues ÷ SPs estimados' },
  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-sm text-gray-500 mt-1">Acurácia do planejamento de sprint e qualidade das estimativas</p>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        <ChartPlaceholder title="Acurácia de Estimativa por Sprint" description="SPs estimados vs. entregues — histórico 6 meses" height={260} />
        <ChartPlaceholder title="Distribuição de Reestimativas" description="Frequência e magnitude das mudanças de estimativa" height={260} />
        <ChartPlaceholder title="Latência de Planejamento" description="Dias entre refinamento e início de sprint" height={260} />
        <ChartPlaceholder title="Spillover por Sprint" description="Story points carregados para próximas sprints" height={260} />
      </div>
          ...
          <table className="w-full text-sm">
            ...
            <tbody>
              <tr className="text-gray-400">
                <td className="py-3 text-center" colSpan={6}>Dados serão carregados após sincronização</td>
              </tr>
            </tbody>
          </table>
        </div>
